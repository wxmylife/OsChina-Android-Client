...
public class UserFragment extends BaseFragment {
    ...
    public static UserFragment newInstance(Object... args) {
    ...
    public View getContentView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable
        ...
        return inflater.inflate(R.layout.user_fragment_main, null);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        name = findViewById(R.id.user_fragment_main_name);
        age = findViewById(R.id.user_fragment_main_age);
        final UserInfo userInfo = new UserInfo();
        userInfo.setAge(16);
        userInfo.setName("张三");
        findViewById(R.id.user_fragment_main_btn).setOnClickListener(new View.OnClickListener() {
            @Override
